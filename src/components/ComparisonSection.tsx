      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.6 }}
            className="bg-white/10 rounded-2xl p-8 md:p-12 space-y-8 backdrop-blur-sm"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-red-600/20 to-red-700/10 border-2 border-red-600/30 rounded-2xl p-8 md:p-12 space-y-8 backdrop-blur-sm relative overflow-hidden"
          >
            {/* Glow effect */}
